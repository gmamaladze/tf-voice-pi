...
def label_wav(dev, labels, graph, input_name, output_name, how_many_labels):
  ...
  while True:
      ...
      if l:
          buff.append(data)
      extra = len(buff) - 320044;
      if extra>0:
          del buff[:extra]
          run_graph(buff, labels_list, input_name, output_name, how_many_labels)


def main(_):
  """Entry point for script, converts flags to arguments."""
  label_wav(FLAGS.dev, FLAGS.labels, FLAGS.graph, FLAGS.input_name,
...
if __name__ == '__main__':
  ...
  parser.add_argument(
      '--dev', type=str, default='', help='Microphone device name')
  parser.add_argument(
